  ...
  return (
    <>
      ...
      <main className="relative">
        <SectionPageTitle subtitle="We offer a variety of services here to get you started and successfully suite every need. Choose the services that’s right for you.">
          Services
        </SectionPageTitle>
